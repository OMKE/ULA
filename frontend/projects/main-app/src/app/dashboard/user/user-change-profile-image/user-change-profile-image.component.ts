...
@Component({
    selector: "app-user-change-profile-image",
    templateUrl: "./user-change-profile-image.component.html",
    styleUrls: ["./user-change-profile-image.component.scss"],
})
export class UserChangeProfileImageComponent implements OnInit {
