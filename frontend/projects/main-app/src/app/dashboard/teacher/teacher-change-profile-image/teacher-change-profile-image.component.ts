...
@Component({
    selector: "app-teacher-change-profile-image",
    templateUrl: "./teacher-change-profile-image.component.html",
    styleUrls: ["./teacher-change-profile-image.component.scss"],
})
export class TeacherChangeProfileImageComponent implements OnInit {
